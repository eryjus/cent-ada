//=================================================================================================================
//  enum.hh -- This header contains the enumeration definitions used throughout the compiler
//
...
//  -----------  -------  -------  ----  -------------------------------------------------------------------------
//  2025-Mar-21  Initial   0.0.0   ADCL  Initial version
//
//=================================================================================================================
...
//    --------------------------------------------------
enum class DiagID {
    IllegalIdentifier = 0x0001,         // The identifier does not meet language requirements
    IllegalInteger = 0x0002,            // The integer does not meet language requirements
    IllegalReal = 0x0003,               // The real does not meed language requirements
    IllegalString = 0x0004,             // The string was not terminated
    IllegalBase = 0x0005,               // Based number contains an illegal base
    IllegalDigit = 0x0006,              // Based number contains an illegal digit
