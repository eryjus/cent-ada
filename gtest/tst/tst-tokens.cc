//===================================================================================================================
// tst-tokens.cc -- This google test executes tests against the token stream
//
...
//    ----------------------
TEST_F(TokTest, StreamTest000) {
    TestTokenStream("package test is",
        {
            TokenType::TOK_PACKAGE,
            TokenType::TOK_IDENTIFIER,
            TokenType::TOK_IS
        }
    );
}
TEST_F(TokTest, StreamTest001) {
    TestTokenStream("COUNT, SUM  : INTEGER;",
        {
            TokenType::TOK_IDENTIFIER,
            TokenType::TOK_COMMA,
            TokenType::TOK_IDENTIFIER,
...
TEST_F(TokTest, StreamTest002) {
    TestTokenStream("SIZE        : INTEGER range 0 .. 10_000 := 0;",
        {
            TokenType::TOK_IDENTIFIER,
            TokenType::TOK_COLON,
            TokenType::TOK_IDENTIFIER,
            TokenType::TOK_RANGE,
            TokenType::TOK_UNIVERSAL_INT_LITERAL,
            TokenType::TOK_DOUBLE_DOT,
            TokenType::TOK_UNIVERSAL_INT_LITERAL,
            TokenType::TOK_ASSIGNMENT,
            TokenType::TOK_UNIVERSAL_INT_LITERAL,
            TokenType::TOK_SEMICOLON
        }
    );
}
TEST_F(TokTest, StreamTest003) {
    TestTokenStream("SORTED      : BOOLEAN := FALSE;",
        {
            TokenType::TOK_IDENTIFIER,
            TokenType::TOK_COLON,
            TokenType::TOK_IDENTIFIER,
...
TEST_F(TokTest, StreamTest004) {
    TestTokenStream(
        ...
        )",
        {
            ...
            TokenType::TOK_IDENTIFIER,
            TokenType::TOK_IS,
            TokenType::TOK_LEFT_PARENTHESIS,
            TokenType::TOK_IDENTIFIER,
            TokenType::TOK_COMMA,
            TokenType::TOK_IDENTIFIER,
            TokenType::TOK_COMMA,
            ...
            TokenType::TOK_COMMA,
            TokenType::TOK_IDENTIFIER,
            TokenType::TOK_RIGHT_PARENTHESIS,
            TokenType::TOK_SEMICOLON,
